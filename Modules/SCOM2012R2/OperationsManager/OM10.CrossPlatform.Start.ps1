...
# Cross Platform cmdlets work with Powershell verion 3.0 or greater only

$scriptPath = Split-Path -parent $MyInvocation.MyCommand.Definition
$psScript = $scriptPath + "\OM10.CrossPlatform\OM10.CrossplatformInvalidPSVersion.ps1"
if ((Get-Host).Version.Major -ge [int]3) {Import-Module $scriptPath\OM10.CrossPlatform}
else                                     {& "$psScript"}

# SIG # Begin signature block
# MIIauQYJKoZIhvcNAQcCoIIaqjCCGqYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjraS6JQn0Cx5nk5RRJ//W7Pw
# fPagghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFER0
# b+ZsoHg6P0ixFiypwDoYG42fMFoGCisGAQQBgjcCAQwxTDBKoCyAKgBNAGkAYwBy
# AG8AcwBvAGYAdAAgAEMAbwByAHAAbwByAGEAdABpAG8AbqEagBhodHRwOi8vd3d3
# Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAn7V/RKwXWbG4Bf+SpWso
# 0LctKdsIh5bKsaMd1jwGJlkufMoGKoscECyY7It1k1Wdzx7rAacqKv7eAd5HCIou
# b9qdAvY8rhUnP4vatXzq8RI7sW9V1YQL1AP7d0j4P1QvaV6YQJ4vjVemzS5oTs1U
# qqWmW0Da3r8XwnldGsmlkuIMlPi+KXvi6rXjq4WXi9GubIAKMwUhk48oHOFUICcZ
# wwlXAAHNR4IxaTjPHsAhE+AWvnsd5s24WxL0cWvf6137EJmXJYzjGXPSYnbHuAOU
# SAn0Uz2b/szIA0Or7O9GUSyM4rZDSUvgWxfvHnqK6AQihdCQDo09R3JD1rPYsBVk
# zqGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3MQswCQYDVQQGEwJV
...
# NTIzN1owIwYJKoZIhvcNAQkEMRYEFII8PBHX35SvC8ZDIOYwjKNy0MYiMA0GCSqG
# SIb3DQEBBQUABIIBADpPxW1Ic+M4pQPfnE5Ellf8OB/P2IGz31s0NakeJa712XZ+
# 5HjcXbupWiBvRhiqGUMt79ap1R2v9C7+YRKdKIMsv2KmD0kYiK8xoXhwaVrkE5li
# dSCJz1h46CrHP6HyHX61ceX0TQtsfCGzwjotU4N5mR+PsiILxtL2rMaz28q5ZoDN
# WQajdshfNgUChZAG9xD8qrMSb83qeW0A1uSK+eAyH6cDSHmRGlKILyMmjatd0GIn
# hDc51EgwGlTb31HhA57t3bQGEd2IT/YdYolvT0dCXSR1K0Fgy2jJ/eXa5XzyLjtt
# IE9hbikkvyPEULeEy7KczpFK3XE2q0RINemPGKg=
