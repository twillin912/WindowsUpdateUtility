#
# Module manifest for module 'OperationsManagerV10CrossPlatformCmdlets'
#
#
...
NestedModules = 'Microsoft.SystemCenter.CrossPlatform.PowerShell.dll'
                

# This GUID is used to uniquely identify this module.
GUID = '8C727141-E39C-4A14-A087-1B98CEED2FD5'
...
Description = 'Operations Manager OperationsManagerV10 CrossPlatform Module'
...
FormatsToProcess = 'Microsoft.SystemCenter.CrossPlatform.format.ps1xml'

# A list of assemblies that must be loaded before this module can work.
RequiredAssemblies = @()

CmdletsToExport  = 'Invoke-SCXDiscovery',
 				   'Install-SCXAgent',
 				   'Set-SCXResourcePool',
				   'Update-SCXAgent',
				   'Remove-SCXAgent',
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUKvrsb8DusOYcmOZ9uuvn37/P
# 4LWgghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOOB
# AYoPq5tybWWxpUe/CS/vK5p0MFoGCisGAQQBgjcCAQwxTDBKoCyAKgBNAGkAYwBy
# AG8AcwBvAGYAdAAgAEMAbwByAHAAbwByAGEAdABpAG8AbqEagBhodHRwOi8vd3d3
# Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEA3CD4aJsMOsYBd9KXuxY9
# MCLR6Ma37A/TnyyfurDkixcQCxIO9BHlisWTCU9wzVvIdWcsZIhYnR1Vbfk1Tdb4
# eulMLD2c4JTTgBXGWQ07gXCeDhlqAoUPlm/83fQMmBmP2UIEjOVRHGnqibwaFia/
# us9vTk2myOR/DiUI+2eCbC3XUMQ+VNWvfR9frdVhvyFIhpbAX656Z2BNXKZ3THMs
# CuDG51roTs3y3s3mzttWPibyQ8HoontuYGoqZSkNXKBjAy0pmPbWgc7od3k15mLQ
# sc0afuiwWY2uvEsOMjJGG1TZYwzTPyOxeAFShvE/G9zkbHfiSqUfaW4vdABf0XY9
# A6GCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3MQswCQYDVQQGEwJV
...
# NTIzN1owIwYJKoZIhvcNAQkEMRYEFGywdAOzyKki41sGn876DOSiwxcOMA0GCSqG
# SIb3DQEBBQUABIIBAIOkls8L2h+ZRQaYpQR3NtKqvG5mqvycwqtqZxi24ZKl82NP
# 0lY/vLWH0Aqr0iKwgMDDKD6IxDQMTnmsjlMF+alwovHMEkO3xrtDQ77FF8g6gHQd
# LolPmPGXgTI4xGB5IWv9OC18Oh2gB1kqN6BL6ZiYXRU6DOtrgNtwlEVLNsUSTeJ4
# G9zJ0wQPOjlABGnfQxzSrgtlOoAKJxcEZJZIqRIxKd8lPXZNKJbCybZJcpqXDi5E
# bvq89qx6YvaLEhTkuQBlt+q8Ee4+CmqR6rWd8xwl6KZfgib3bMdR3cRibAWBjwax
# StOY/VGxItbvCMczFm2pC7Jsu3iuPy6HfCHeMRw=
